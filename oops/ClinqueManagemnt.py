...
class Doctor:
    ...
    # def __init__(self,doctor_name=input("enter doctor_name"),doctor_id=input("enter doctor id"),doctor_specialization=input("enter doctor specilaizaton")):
    #     self.doctor_name=doctor_name
    #     self.doctor_id=doctor_id
    #     self.specilaization=doctor_specialization
    # self.availability=avail   avail=parser.parse(input("Enter the date in the following format (Aug 28 1999 3:00AM)"))
    # def __iter__(self):
    #     return Doctor
    # def __next__(self):
    #     retur
    # def getdoctordetails(doctor_id):
    #     for i in Doctor:
    #         if i.doctor_id==doctor_id:
    #             return doctor_name,doctor_id,specilaization,availability
    # def __iter__(self):
    #     return Doctor
...
class Patient:
    # def __init__(self,patient_name=input("enter patient name"),patient_id=input("patient id"),patient_phone_number=input("enter patient phno"),doctor_id=input("enter doctor_id")):
    #     self.patient_name=patient_name
    #     self.patient_id=patient_id
    #     self.patient_phone_number=patient_phone_number
    #     self.Doc=doctor_id
    patient_doctor = Doctor()  # variable storing the doctor details of the patient
...
class Clinique():
    ...
    def doctor_details(self, doctor_name=str(), doctor_id=int(), doctor_specialization=str(), dates=datetime.datetime):
        ...
        for i in range(len(self.doctors)):  # traversing through all the doctor objects
            ...
            if doctor_id == int() and doctor_specialization == str() and dates == datetime.datetime:  # getting towards the correct attribute
                ...
                # print("inside elif")
                # print(type(self.doctors[i].doctor_id))
                # print("doctor_id",type(doctor_id))
    ...
    #     print(self.patient_phone_number)
    #     if
    #     print(self.Doc.doctor_name)
    #     print(self.Doc.doctor_id)
    #     print(self.Doc.specilaization)
    #     print(self.Doc.availability)
    # def search(self,patient_name,patient_id,patient_phone_number):
    #     if self.patients.patient_name==patient_name and self.patients.patient_id==patient_id and self.patients.patient_phone_number==patient_phone_number:
    #         self.patients


clinique = Clinique()
number_of_doctors = int(input("enter the number of doctpors"))
